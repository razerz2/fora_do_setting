...
class VerificarGastosProfissionais extends Command
{
   /**
     ...
     * @var string
     */
    protected $signature = 'gastos_profissionais:verificar';
    ...
    public function handle()
    {
        ...
        $gastos = GastosProfissionais::where('recursivo', true)
        ...
        $this->info("Verificação de gastos profissionais recursivos concluída.. $registrosCriados registros realizados.");
        $this->registrarNotificacao("Verificação de gastos profissionais recursivos concluída.. $registrosCriados registros realizados.");
        \Log::info("Verificação de gastos profissionais recursivos concluída.. $registrosCriados registros realizados.");
        return 0;
    }
