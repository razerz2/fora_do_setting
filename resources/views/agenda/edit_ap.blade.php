    ...
    <div class="row align-items-center justify-content-center">
        ...
        <div class="col-xl-10 col-lg-8">
            <div class="card shadow mb-4">
                <form action="{{ route('Agendamento.storeReagendarPaciente') }}" method="POST">
                    @csrf
                    <input type="hidden" name="id_agendamento" value="{{ $agendamento->id_agendamento }}">
                    <input type="hidden" name="paciente_id" value="{{ $agendamento->agendamentoPaciente->paciente_id}}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user" id="text02"
                                        value="{{ $agendamento->agendamentoPaciente->paciente->nome_paciente }}"
                        ...
                        <div class="row align-items-center justify-content-center">
                            ...
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input id="CheckPresencial" class="form-check-input" type="checkbox" name="presencial" {{ $agendamento->agendamentoPaciente->presencial ? 'checked' : '' }}>
                                    <label class="form-check-label" for="CheckPresencial">
                                        Presencial
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input id="CheckOnline" class="form-check-input" type="checkbox" name="online" {{ !$agendamento->agendamentoPaciente->presencial ? 'checked' : '' }}>
                                    <label class="form-check-label" for="CheckPresencial">
                                        Online
                                    </label>
                                </div>
