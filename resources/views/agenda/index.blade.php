...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="text-center m-0 font-weight-bold text-secondary">Agendamentos Cadastrados</h6>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        @foreach ($agendamentos as $agendamento)
                            <tr class="text-center">
                                ...
                                <td class="text-center"><small>{{ $agendamento->agendamentoTipo->tipo_agendamento }}</small></td>
                                ...
                                <td align="center">
                                    ...
                                    @elseif ($agendamento->at_id != 2)
                                        <button data-toggle="modal" data-target="#desmarcar" class="btn btn-secondary btn-sm"
            ...
            <div class="modal-content">
                ...
                <form id="marcarForm" action="" method="POST">
                    ...
                    <div class="modal-body">
                        <p class="text-center">
                            Tem certeza de que deseja marcar no horário Nº "<span id="info-agendamento"></span>"?
                        </p>
                        <input type="hidden" name="id_agendamento" id="n_id_agendamento" value="">
                        <div class="form-group text-center">
                            <label for="agendamento_periodo">Selecione o tipo de agendamento:</label>
                            <div class="row align-items-center justify-content-center text-center">
                                <div class="col-md-5">
                                    <select id="agendamento_tipo" name="at_id" class="form-control form-control-user text-center" required>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="desmarcarForm" action="" method="POST">
                    ...
                    <div class="modal-body">
                        <p class="text-center">
                            Tem certeza de que deseja desmarcar agendamento Nº "<span id="iinfo-agendamento"></span>"?
                        </p>
                        <input type="hidden" name="id_agendamento" id="nn_id_agendamento" value="">
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="desativarForm" action="" method="POST">
                    ...
                    <div class="modal-body">
                        <p class="text-center">
                            Tem certeza de que deseja excluír o horário Nº "<span id="info-reg"></span>"?
                        </p>
                        <input type="hidden" name="id_agendamento" id="id_agendamento_n" value="">
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
