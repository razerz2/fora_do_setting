...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"> Sessões \ <span class="h6 mb-0 text-gray-800"> Visualizar Sessão Cancelada </span>
        </h1>
    </div>
        ...
        <div class="col-xl-10 col-lg-8">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-center">
                    <h6 class="m-0 font-weight-bold text-secondary text-center">Sessão Cancelada</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                    <div class="row align-items-center justify-content-center">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-user" id="text03"
                                    value="R$ {{ number_format($sessao->valor, 2, ',', '.') }}" aria-describedby="DiaHelp" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row align-items-center justify-content-center">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-user" id="text07"
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="text04">Motivo:</label>
                                <input type="text" class="form-control form-control-user" id="text08"
                                    value="{{ $sessao->nome_motivo }}"
                                    aria-describedby="AgendamentoHelp" readonly>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="text04">Descrição:</label>
                                <input type="text" class="form-control form-control-user" id="text09"
                                    value="{{ $sessao->descricao_motivo }}"
                                    aria-describedby="AgendamentoHelp" readonly>
                            </div>
                        </div>
