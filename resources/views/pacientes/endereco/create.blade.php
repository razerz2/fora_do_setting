...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Pacientes \ <span class="h6 mb-0 text-gray-800"> Cadastrar endereço do Paciente </span></h1>
    </div>
    ...
    <div class="row align-items-center justify-content-center">
        ...
        <div class="col-xl-10 col-lg-8">
            <div class="card shadow mb-4">
                <form id="userForm" action="{{ route('PacientesEndereco.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row align-items-center justify-content-center">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user" id="exampleInputEndereco"
                                        value="{{ old('endereco') }}" name="endereco" aria-describedby="EnderecoHelp"
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user" id="exampleInputNEndereco"
                                        aria-describedby="NEnderecoHelp" value="{{ old('n_endereco') }}" name="n_endereco"
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user"
                                        ...
                                        value="{{ old('complemento') }}" name="complemento"
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user" id="exampleInputNEndereco"
                                        aria-describedby="CEPHelp" value="{{ old('cep') }}" name="cep"
    ...
    <script>
        // Carrega formulário ao marcar caixa...
        function atualizarEndereco() {
            var checkbox = document.getElementById('CheckEndereco');
            var enderecoContainer = document.getElementById('enderecoContainer');
            ...
            if (checkbox.checked) {
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="exampleInputEndereco">Endereço:</label>
                            <input type="text" class="form-control form-control-user" id="exampleInputEndereco" value="{{ old('endereco') }}" name="endereco" aria-describedby="EnderecoHelp" placeholder="Digite o endereço..." required>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="exampleInputNEndereco">Nº do Endereço:</label>
                            <input type="text" class="form-control form-control-user" id="exampleInputNEndereco" aria-describedby="NEnderecoHelp" value="{{ old('n_endereco') }}" name="n_endereco" placeholder="Digite o nº..." required>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="exampleInputComplemento">Complemento:</label>
                            <input type="text" class="form-control form-control-user" id="exampleInputComplemente" aria-describedby="ComplementoHelp" value="{{ old('complemento') }}" name="complemento" placeholder="Digite o complemento do endereço...">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="exampleInputCEP">CEP:</label>
                            <input type="text" class="form-control form-control-user" id="exampleInputNEndereco" aria-describedby="CEPHelp" value="{{ old('cep') }}" name="cep" placeholder="Digite o CEP..." required>
                        </div>
                    </div>
                </div>
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="stateSelect">Estado:</label>
                            <select id="stateSelect" name="estado_id" class="form-control form-control-user" onchange="handleStateChange()" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="citySelect">Cidade:</label>
                            <select id="citySelect" name="cidade_id" class="form-control form-control-user" required>
                ...
                `;
                enderecoContainer.innerHTML = formulario;
                listarPaises();
            } else {
