...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Pacientes \ <span class="h6 mb-0 text-gray-800"> Cadastrar endereço do Paciente
            </span></h1>
    </div>
    ...
    <div class="row align-items-center justify-content-center">
        ...
        <div class="col-xl-10 col-lg-8">
            <div class="card shadow mb-4">
                <form id="userForm" action="{{ route('PacientesEndereco.store') }}" method="post"
    ...
    <script src="{{ asset('js/pacientes/endereco/create.js') }}" ></script>
@endsection
