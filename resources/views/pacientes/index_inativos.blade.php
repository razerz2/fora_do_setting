...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="text-center m-0 font-weight-bold text-secondary">Pacientes Inativos</h6>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <div class="d-flex">
                        ...
                        <a href="{{ route('Pacientes.index') }}" class="btn btn-secondary btn-sm ml-auto">
                            <i class="fa fa-power-off" aria-hidden="true"></i> Ativos
                        </a>
                    </div>
                </div>
            </div>
                    ...
                    <tbody>
                        @foreach ($pacientes as $paciente)
                            <tr class="text-center">
                                ...
                                <td class="text-center"><small>{{ $paciente->inativacao->motivoInativacao->nome_mi }}</small></td>
                                <td align="center">
