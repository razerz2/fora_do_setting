...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="text-center m-0 font-weight-bold text-secondary">Relatório de Pacientes Ativos</h6>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
    ...
    <script>
        ...
        document.getElementById('downloadExcel').addEventListener('click', function () {
            ...
            XLSX.utils.book_append_sheet(workbook, worksheet, 'Pacientes Ativos');
    
            // Gerar e baixar o arquivo Excel
            XLSX.writeFile(workbook, 'pacientes_ativos.xlsx');
        });
    </script>
@endsection
