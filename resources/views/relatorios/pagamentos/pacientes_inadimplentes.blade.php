...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="text-center m-0 font-weight-bold text-secondary">Relatório de Pacientes Inadimplentes</h6>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <tbody>
                        @foreach ($dados as $sessao)
                            <tr class="text-center">
                                ...
                                <td class="text-center"><small>{{ $sessao->total_sessoes }}</small></td>
                                <td class="text-center"><small>R$ {{ number_format($sessao->valor_total, 2, ',', '.') }}</small></td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
    ...
    <script>
        ...
        document.getElementById('downloadExcel').addEventListener('click', function () {
            ...
            XLSX.writeFile(workbook, 'pacientes_inadimplentes.xlsx');
        });
    </script>
@endsection