...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="text-center m-0 font-weight-bold text-secondary">Relatórios de Gastos Pessoais</h6>
        </div>
        <div class="card-body">
                ...
                <div class="col md-10">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            <ul>
                                <li><a href="{{ route('Relatorios.GastosPessoaisMes') }}">Gastos Pessoais</a></li>
                            </ul>
                        </li>
                        <li class="list-group-item">
                            <ul>
    ...
    <div class="modal modal-danger fade" id="modal_gasto_periodo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="form_pagamento_periodo" action="{{ route('Relatorios.GastosPessoaisPeriodo') }}" method="POST">
                    @csrf
